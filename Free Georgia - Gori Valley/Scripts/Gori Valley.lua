...
Spawn_RU_MIG31_Intercept = SPAWN:New( 'RU MIG-31@RAMP-Intercept' ):Limit( 2, 24 ):Schedule( 600, 0.4 ):RandomizeRoute( 1, 1, 8000 )
...
Spawn_BE_F16A = SPAWN:New( 'BE F-16A@RAMP-Air Support Mountains' ):Limit( 2, 16 ):Schedule( 900, 0.5 ):RandomizeRoute( 1, 1, 6000 ):RepeatOnEngineShutDown()
Spawn_US_F16C = SPAWN:New( 'US F-16C@RAMP-Sead Gori' ):Limit( 2, 8 ):Schedule( 600, 0.5 ):RandomizeRoute( 1, 1, 6000 ):RepeatOnEngineShutDown()
...
Spawn_US_Platoon_Left = SPAWN:New( 'US Tank Platoon Left' ):Limit( 12, 150 ):Schedule( 200, 0.4 ):RandomizeTemplate( Spawn_US_Platoon ):RandomizeRoute( 3, 3, 1500 )
Spawn_US_Platoon_Middle = SPAWN:New( 'US Tank Platoon Middle' ):Limit( 12, 150 ):Schedule( 200, 0.4 ):RandomizeTemplate( Spawn_US_Platoon ):RandomizeRoute( 3, 3, 1500 )
Spawn_US_Platoon_Right = SPAWN:New( 'US Tank Platoon Right' ):Limit( 12, 150 ):Schedule( 200, 0.4 ):RandomizeTemplate( Spawn_US_Platoon ):RandomizeRoute( 3, 3, 1500 )
...
Spawn_US_Platoon_Left = SPAWN:New( 'US Patriot Defenses 1' ):Limit( 10, 20 ):Schedule( 400, 0.4 ):RandomizeTemplate( Spawn_US_Patriot_Defense ):RandomizeRoute( 3, 0, 2000 )
Spawn_US_Platoon_Middle = SPAWN:New( 'US Patriot Defenses 2' ):Limit( 10, 20 ):Schedule( 400, 0.4 ):RandomizeTemplate( Spawn_US_Patriot_Defense ):RandomizeRoute( 3, 0, 2000 )
Spawn_US_Platoon_Right = SPAWN:New( 'US Patriot Defenses 3' ):Limit( 10, 20 ):Schedule( 400, 0.4 ):RandomizeTemplate( Spawn_US_Patriot_Defense ):RandomizeRoute( 2, 0, 2000 )
